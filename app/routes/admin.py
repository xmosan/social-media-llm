...
<body>
  ...
  <div class="muted">Upload → Generate → Approve.</div>
  ...
  return `
    <div class="post" id="post-${p.id}">
      ...
      <div class="actions">
        ...
        <button class="primary" onclick="approve(${p.id})">Approve (post)</button>
